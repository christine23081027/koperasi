        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(url('/simpanan')); ?>" class="btn btn-sm btn-outline-secondary fw-bold">← Kembali</a>
                </div>

                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        <form action="<?php echo e(url('/simpanan')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\simpan_pinjam\resources\views/simpanan/create.blade.php ENDPATH**/ ?>