        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-dark navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active fw-bold" href="<?php echo e(url('/dashboard')); ?>">Dashboard</a></li>
            ...
            <div class="col-md-3">
                <div class="card bg-white text-dark border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h2 class="font-weight-bold my-2 text-primary"><?php echo e($total_anggota); ?></h2>
            ...
            <div class="col-md-3">
                <div class="card bg-white text-dark border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h2 class="font-weight-bold my-2 text-success">Rp <?php echo e(number_format($total_simpanan)); ?></h2>
            ...
            <div class="col-md-3">
                <div class="card bg-white text-dark border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h2 class="font-weight-bold my-2 text-danger">Rp <?php echo e(number_format($total_pinjaman)); ?></h2>
            ...
            <div class="col-md-3">
                <div class="card bg-white text-dark border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h2 class="font-weight-bold my-2 text-warning">Rp <?php echo e(number_format($total_angsuran)); ?></h2>
...
</html><?php /**PATH C:\laragon\www\simpan_pinjam\resources\views/dashboard.blade.php ENDPATH**/ ?>